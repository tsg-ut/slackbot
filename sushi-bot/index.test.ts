...
describe('sushi-bot', async () => {
	...
	beforeEach(async () => {
		...
		vi.mocked(moment).mockReturnValue(originalMoment('2023-01-01T00:00:00.000Z'));
	});
	...
	it('reacts to "あさ！" with :100: at 8:59:59', () => new Promise<void>(async (resolve) => {
		vi.mocked(moment).mockReturnValue(originalMoment('2023-01-01T08:59:59+09:00'));
	...
	it('reacts to "あさ！" with :95: at 9:00:01', () => new Promise<void>((resolve) => {
		vi.mocked(moment).mockReturnValue(originalMoment('2023-01-01T09:00:01+09:00'));
	...
	it('reacts to "起床ランキング 確認', () => new Promise<void>((resolve) => {
		vi.mocked(moment).mockReturnValue(originalMoment('2023-01-01T10:00:00+09:00'));
		slack.on('chat.postMessage', ({username, channel, text}) => {
			expect(username).toBe('sushi-bot');
			expect(channel).toBe("D00000000");
	...
	it('reacts to "よる！" at 21:00 with :108:', () => new Promise<void>((resolve) => {
		vi.mocked(moment).mockReturnValue(originalMoment('2023-01-01T21:00:00+09:00'));
	...
	it('reacts to "ひる" at 12:00 with :108:', () => new Promise<void>((resolve) => {
		vi.mocked(moment).mockReturnValue(originalMoment('2023-01-01T12:00:00+09:00'));
	...
	it('reacts to "ゆうがた！" at 16:30 with :108:', () => new Promise<void>((resolve) => {
		vi.mocked(moment).mockReturnValue(originalMoment('2023-01-01T16:30:00+09:00'));
