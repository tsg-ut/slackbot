...
exports.default = (state, player) => {
    const questionsText = player.questions.length === 0
        ? 'まだ質問をしていません。'
        : player.questions
            .map((q, i) => {
    ...
    if (player.questionCount < 19) {
        blocks.push({
            ...
            element: {
                ...
                max_length: const_1.MAX_QUESTION_LENGTH,
                placeholder: {
                    type: 'plain_text',
            ...
            label: {
                type: 'plain_text',
                text: `質問する (最大${const_1.MAX_QUESTION_LENGTH}文字)`,
            },
        }, {
            type: 'actions',
    ...
    blocks.push({
        ...
        element: {
            ...
            max_length: const_1.MAX_ANSWER_LENGTH,
            placeholder: {
                type: 'plain_text',
                text: 'お題だと思う単語を入力',
            },
        ...
        label: {
            type: 'plain_text',
            text: `答えを当てる (最大${const_1.MAX_ANSWER_LENGTH}文字)`,
        },
    }, {
        type: 'actions',
