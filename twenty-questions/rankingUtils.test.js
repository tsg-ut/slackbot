...
describe('rankingUtils', () => {
    describe('getRankedPlayers', () => {
        it('handles single player', () => {
            ...
            const result = (0, rankingUtils_1.getRankedPlayers)(players);
    ...
    describe('getRankEmoji', () => {
        it('returns correct emoji for rank 1', () => {
            expect((0, rankingUtils_1.getRankEmoji)(1)).toBe(':first_place_medal:');
        });
        it('returns correct emoji for rank 2', () => {
            expect((0, rankingUtils_1.getRankEmoji)(2)).toBe(':second_place_medal:');
        });
        it('returns correct emoji for rank 3', () => {
            expect((0, rankingUtils_1.getRankEmoji)(3)).toBe(':third_place_medal:');
        });
        it('returns rank string for rank 4 and above', () => {
            expect((0, rankingUtils_1.getRankEmoji)(4)).toBe('4位');
            expect((0, rankingUtils_1.getRankEmoji)(5)).toBe('5位');
            expect((0, rankingUtils_1.getRankEmoji)(10)).toBe('10位');
        });
    });
});
