...
const achievements: Achievement[] = [
	...
	},
	{
		...
		difficulty: 'medium',
		title: 'ウサギとカメ',
		condition: '10人以上が参加したAtCoderのレーティング更新対象の大会で、atcoderボット登録ユーザーの中で最初の問題を一番早く (ペナルティは考慮しない) 回答する',
		category: 'atcoder',
	...
	},
	{
		...
		difficulty: 'hard',
		title: '連射王高橋君',
		condition: '10人以上が参加したAtCoderのレーティング更新対象の大会で、atcoderボット登録ユーザーの中で最初の問題を一番早く (ペナルティは考慮しない) 回答する、を5回達成する',
		category: 'atcoder',
		counter: 'atcoder-fastest',
		value: 5,
	},
	{
		...
		difficulty: 'professional',
		title: '覚醒ノ高橋君',
		condition: '10人以上が参加したAtCoderのレーティング更新対象の大会で、atcoderボット登録ユーザーの中で最初の問題を一番早く (ペナルティは考慮しない) 回答する、を20回達成する',
		category: 'atcoder',
		counter: 'atcoder-fastest',
		value: 20,
	},
