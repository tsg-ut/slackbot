...
const achievements: Achievement[] = [
	...
	// resistor-quiz
	{
		id: 'resistor-quiz-answer-1',
		difficulty: 'easy',
		title: 'オームの法則',
		condition: '抵抗器当てクイズで正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-10',
		difficulty: 'medium',
		title: 'カラーコード読み取り名人',
		condition: '抵抗器当てクイズで10回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer',
		value: 10,
	},
	{
		id: 'resistor-quiz-answer-100',
		difficulty: 'hard',
		title: 'レジスタンス',
		condition: '抵抗器当てクイズで100回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer',
		value: 100,
	},
	{
		id: 'resistor-quiz-answer-1000',
		difficulty: 'professional',
		title: 'エレクトロニクス・マエストロ',
		condition: '抵抗器当てクイズで1000回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer',
		value: 1000,
	},
	{
		id: 'resistor-quiz-answer-easy-1',
		difficulty: 'easy',
		title: '簡単モード',
		condition: '抵抗器当てクイズのeasyモードで正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-easy',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-easy-100',
		difficulty: 'medium',
		title: '基本抵抗マスター',
		condition: '抵抗器当てクイズのeasyモードで100回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-easy',
		value: 100,
	},
	{
		id: 'resistor-quiz-answer-hard-1',
		difficulty: 'medium',
		title: '許容差も読めるよ',
		condition: '抵抗器当てクイズのhardモードで正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-hard',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-hard-50',
		difficulty: 'hard',
		title: '精密抵抗器職人',
		condition: '抵抗器当てクイズのhardモードで50回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-hard',
		value: 50,
	},
	{
		id: 'resistor-quiz-answer-no-hint-1',
		difficulty: 'hard',
		title: 'ヒント不要',
		condition: '抵抗器当てクイズでヒントなしで正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-no-hint',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-no-hint-10',
		difficulty: 'professional',
		title: '一瞬で見抜く',
		condition: '抵抗器当てクイズでヒントなしで10回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-no-hint',
		value: 10,
	},
	{
		id: 'resistor-quiz-answer-first-hint-1',
		difficulty: 'medium',
		title: '最初のヒントで分かった',
		condition: '抵抗器当てクイズで最初のヒントまでに正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-first-hint',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-first-hint-50',
		difficulty: 'hard',
		title: '早解きエキスパート',
		condition: '抵抗器当てクイズで最初のヒントまでに50回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-first-hint',
		value: 50,
	},
	{
		id: 'resistor-quiz-answer-mega-ohm-1',
		difficulty: 'medium',
		title: 'メガオーム',
		condition: '抵抗器当てクイズで1MΩ以上の抵抗値を正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-mega-ohm',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-mega-ohm-10',
		difficulty: 'hard',
		title: '高抵抗スペシャリスト',
		condition: '抵抗器当てクイズで1MΩ以上の抵抗値を10回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-mega-ohm',
		value: 10,
	},
	{
		id: 'resistor-quiz-answer-kilo-ohm-1',
		difficulty: 'easy',
		title: 'キロオーム',
		condition: '抵抗器当てクイズで1kΩ以上の抵抗値を正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-kilo-ohm',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-kilo-ohm-100',
		difficulty: 'medium',
		title: '標準抵抗愛好家',
		condition: '抵抗器当てクイズで1kΩ以上の抵抗値を100回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-kilo-ohm',
		value: 100,
	},
	{
		id: 'resistor-quiz-answer-low-resistance-1',
		difficulty: 'medium',
		title: '低抵抗マニア',
		condition: '抵抗器当てクイズで100Ω未満の抵抗値を正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-low-resistance',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-low-resistance-20',
		difficulty: 'hard',
		title: '微小抵抗コレクター',
		condition: '抵抗器当てクイズで100Ω未満の抵抗値を20回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-low-resistance',
		value: 20,
	},
	{
		id: 'resistor-quiz-answer-e24-1',
		difficulty: 'easy',
		title: 'E24シリーズ',
		condition: '抵抗器当てクイズでE24シリーズの抵抗値を正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-e24',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-e24-500',
		difficulty: 'hard',
		title: 'E24シリーズ博士',
		condition: '抵抗器当てクイズでE24シリーズの抵抗値を500回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-e24',
		value: 500,
	},
	{
		id: 'resistor-quiz-answer-precision-resistor-1',
		difficulty: 'hard',
		title: '精密抵抗器',
		condition: '抵抗器当てクイズのhardモードで許容差1%以下の抵抗器を正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-precision-resistor',
		value: 1,
	},
	{
		id: 'resistor-quiz-answer-precision-resistor-30',
		difficulty: 'professional',
		title: '精密部品エンジニア',
		condition: '抵抗器当てクイズのhardモードで許容差1%以下の抵抗器を30回正解する',
		category: 'resistor-quiz',
		counter: 'resistor-quiz-answer-precision-resistor',
		value: 30,
	},
