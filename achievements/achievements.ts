...
const achievements: Achievement[] = [
  ...
  },
  {
    ...
    title: "あーここすき",
    condition:
      "1つのメッセージに対し10人以上から:koresuki:リアクションをもらう",
    category: "reactions",
    reaction: "koresuki",
    value: 10,
  },
  ...
  },
  {
    ...
    title: "TSGMELTDOWN",
    condition:
      "1つのメッセージに対し5人以上から:chian-ga-nai:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "君はお肉が好き？",
    condition:
      "1つのメッセージに対し5人以上から:shirimetsuretsu:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "お前はナンなんだ",
    condition:
      "1つのメッセージに対し5人以上から:ナンやねん-ナンなので:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "鳥さんが鳴いとるやんけ",
    condition:
      "1つのメッセージに対し5人以上から:hototogisu:リアクションをもらう",
    category: "reactions",
    reaction: "hototogisu",
    value: 5,
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:ojigineko:リアクションをもらう",
    category: "reactions",
    reaction: "ojigineko",
    value: 5,
  },
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:pizzacat83:リアクションをもらう",
    category: "reactions",
    reaction: "pizzacat83",
    value: 5,
  },
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:no-zabuton:リアクションをもらう",
    category: "reactions",
    reaction: "no-zabuton",
    value: 5,
  },
  ...
  },
  {
    ...
    title: "私がプロだ",
    condition:
      "1つのメッセージに対し5人以上から:hakatashi-pro:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:freshpeach:リアクションをもらう",
    category: "reactions",
    reaction: "freshpeach",
    value: 5,
  },
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:scp-040-jp:リアクションをもらう",
    category: "reactions",
    reaction: "scp-040-jp",
    value: 5,
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:contradiction:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "嘘つきは実績の始まり",
    condition:
      "1つのメッセージに対し5人以上から:sorehauso:リアクションをもらう",
    category: "reactions",
    reaction: "sorehauso",
    value: 5,
  },
  {
    ...
    title: "正直者が実績を見る",
    condition:
      "1つのメッセージに対し5人以上から:sorehasou:リアクションをもらう",
    category: "reactions",
    reaction: "sorehasou",
    value: 5,
  },
  ...
  },
  {
    ...
    title: "指差し確認ヨシ！",
    condition:
      "1つのメッセージに対し5人以上から:genbaneko:リアクションをもらう",
    category: "reactions",
    reaction: "genbaneko",
    value: 5,
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:denwaneko:リアクションをもらう",
    category: "reactions",
    reaction: "denwaneko",
    value: 5,
  },
  ...
  },
  {
    ...
    title: "理由もなくチヤホヤされたい",
    condition:
      "1つのメッセージに対し5人以上から:yumemiriamu:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "チョロいなオタク！",
    condition:
      "1つのメッセージに対し10人以上から:yumemiriamu:リアクションをもらう",
    category: "reactions",
    reaction: "yumemiriamu",
    value: 10,
  },
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:kaishaku-chigai:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "自堕落アイドルへの道",
    condition:
      "1つのメッセージに対し5人以上から:kurotorianzu:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "バナナのナナチがゆらゆら",
    condition:
      "1つのメッセージに対し5人以上から:banananachi:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:american-battle-dome:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "桜よくね？",
    condition:
      "1つのメッセージに対し5人以上から:crocodile-with-100-remaining-days-of-life:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:doutan-kyohi:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "実績になるから散歩したい",
    condition:
      "1つのメッセージに対し5人以上から:jimmy-sanpo:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "学歴コンプ",
    condition:
      "1つのメッセージに対し5人以上から:kyoudai-kanjo:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "女医解除",
    condition:
      "1つのメッセージに対し5人以上から:masaka-sakasama:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:nameraka_rotating_rolling_on_the_floor_laughing:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "インドのナンごをたべるんご",
    condition:
      "1つのメッセージに対し5人以上から:appingorou:リアクションをもらう",
    category: "reactions",
    reaction: "appingorou",
    value: 5,
  },
  ...
  },
  {
    ...
    title: "解除それ以上",
    condition:
      "1つのメッセージに対し5人以上から:joyman-takagi:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "実績取るやん",
    condition:
      "1つのメッセージに対し5人以上から:mounttoru:リアクションをもらう",
    category: "reactions",
    reaction: "mounttoru",
    value: 5,
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:ichihime-zekkocho:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "起床時間乱数生成器",
    condition:
      "1つのメッセージに対し5人以上から:lifestyle-breaking:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:understand-1:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    condition:
      "1つのメッセージに対し5人以上から:understand-10:リアクションをもらう",
    category: "reactions",
  ...
  },
  {
    ...
    title: "無知の知",
    condition:
      "1つのメッセージに対し5人以上から:understand-:リアクションをもらう",
    category: "reactions",
    reaction: "understand-",
    value: 5,
  },
  ...
  },
  {
    ...
    title: "やまびこやまびこ",
    condition:
      "pockyに与えた文字列と同一の返答を得る。ただし一度言われたものは不可",
    category: "pocky",
  },
  {
    id: "self-pocky",
  ...
  },
  {
    ...
    title: "(‘ω’)",
    condition:
      "pockyに与えた文字列と同一の、20文字以上の返答を得る。ただし一度言われたものは不可",
    category: "pocky",
  },
  {
    id: "pocky-on-nov-11",
  ...
  },
  {
    ...
    title: "早い立直は一四索",
    condition:
      "麻雀BOTの四麻モードで、6巡以内に一四索の両面待ちで立直を行った上で和了する",
    category: "mahjong",
  },
  {
  ...
  },
  {
    ...
    title: "自陣飛車に好手あり",
    condition:
      "将棋BOTで自陣への飛車打を含む手順で最短勝利する (7手必勝以上に限る)",
    category: "shogi",
  },
  {
    id: "shogi-自陣角",
    ...
    title: "遠見の角に好手あり",
    condition:
      "将棋BOTで自陣への角打を含む手順で最短勝利する (7手必勝以上に限る)",
    category: "shogi",
  },
  {
    id: "shogi-歩成",
  ...
  },
  {
    ...
    title: "三桂あって詰まぬことなし",
    condition:
      "将棋BOTで桂馬を3つ以上所持した初期盤面で最短勝利する (7手必勝以上に限る)",
    category: "shogi",
  },
  {
    id: "shogi-打ち歩詰め",
  ...
  },
  {
    ...
    title: "エヴァリスト・ガロア",
    condition:
      "素数大富豪をドローおよびペナルティ無しで4ターン以内でクリアする",
    category: "prime",
  },
  {
  ...
  },
  {
    ...
    title: "ハイパーロボットロボット",
    condition:
      "ハイパーロボットで8手詰め以上の問題を、1手あたり10秒以内で最短勝利する",
    category: "ricochet-robots",
  },
  {
    ...
    condition:
      "ハイパーロボットで8手詰め以上の問題を、1手あたり5秒以内で最短勝利する",
    category: "ricochet-robots",
  },
  {
    ...
    condition:
      "ハイパーロボットで8手詰め以上の問題を、1手あたり1秒以内で最短勝利する",
    category: "ricochet-robots",
  },
  ...
  },
  {
    ...
    condition:
      "AtCoderのratedな (本人がratedでなくてよい) 大会で全ての問題で正の得点を獲得した状態でレーティングを確定させる",
    category: "atcoder",
  },
  {
    id: "atcoder-repdigit",
    ...
    title: "魔法使い高橋君",
    condition:
      "AtCoderでゾロ目の順位 (10進数、3桁以上に限る) でレーティングを確定させる",
    category: "atcoder",
  },
  {
    id: "atcoder-prime",
  ...
  },
  {
    ...
    title: "器物損壊！高橋君",
    condition:
      "AtCoderのレーティング更新対象の大会で1問も解かずにレーティングを確定させる",
    category: "atcoder",
  },
  {
    ...
    title: "ウサギとカメ",
    condition:
      "10人以上が参加したAtCoderのレーティング更新対象の大会で、最初の問題をatcoderボット登録ユーザーの中で一番早く (ペナルティは考慮しない) 回答する",
    category: "atcoder",
  ...
  },
  {
    ...
    title: "連射王高橋君",
    condition:
      "10人以上が参加したAtCoderのレーティング更新対象の大会で、最初の問題をatcoderボット登録ユーザーの中で一番早く (ペナルティは考慮しない) 回答する、を5回達成する",
    category: "atcoder",
    counter: "atcoder-fastest",
    value: 5,
  },
  {
    ...
    title: "覚醒ノ高橋君",
    condition:
      "10人以上が参加したAtCoderのレーティング更新対象の大会で、最初の問題をatcoderボット登録ユーザーの中で一番早く (ペナルティは考慮しない) 回答する、を20回達成する",
    category: "atcoder",
    counter: "atcoder-fastest",
    value: 20,
  },
  {
    ...
    title: "高橋君の研修",
    condition:
      "AtCoder Beginners Selection (practice A を除く) の問題を1問でも解く",
    category: "atcoder",
  ...
  },
  {
    ...
    title: "全域木",
    condition:
      "AtCoder Beginners Selection (practice A を除く) の問題10問を全完する",
    category: "atcoder",
    counter: "atcoder-abs-solves",
    value: 10,
  },
  {
    ...
    title: "積み重ね",
    condition:
      "AtCoder Beginners Selection (practice A を除く) と競プロ典型90問の問題のうち20問を解く",
    category: "atcoder",
  ...
  },
  {
    ...
    title: "増築王高橋君",
    condition:
      "AtCoder Beginners Selection (practice A を除く) と競プロ典型90問の問題のうち50問を解く",
    category: "atcoder",
    counter: "atcoder-typical-solves",
    value: 50,
  },
  {
    ...
    title: "ほんとうのたたかい",
    condition:
      "AtCoder Beginners Selection (practice A を除く) と競プロ典型90問の問題100問を全完する",
    category: "atcoder",
    counter: "atcoder-typical-solves",
    value: 100,
  },
  ...
  },
  {
    ...
    title: "懐メロハンター",
    condition:
      "アニソン当てクイズで2010年より前に放送されたアニメの曲を正解する",
    category: "anime",
  },
  {
  ...
  {
    id: "kirafan-answer-first-hint-5",
    difficulty: "professional",
    title: "女神候補生",
  ...
  },
  {
    ...
    title: "クロスワード・クローザー",
    condition:
      "crosswordでクリアを決定する最後の単語を回答する。ただしそのゲームにおいてそれ以外に回答を行ってはいけない (正解・不正解を問わない)",
    category: "crossword",
  },
  {
    ...
    condition:
      "crosswordで制限時間が切れる2秒以内に、クリアを決定する最後の単語を回答する",
    category: "crossword",
  },
  {
    ...
    condition:
      "crosswordで制限時間の1/4以下の時間でクリアしたゲームにおいて、1マス以上のマスを開ける",
    category: "crossword",
  },
  {
    ...
    condition:
      "crosswordでクリアしたゲームにおいて、20個以上の誤答を行い、一度も正解しない",
    category: "crossword",
  },
  {
    ...
    condition:
      "crosswordで1ゲームに11人以上が正答した状態でクリアしたゲームにおいて、1マス以上のマスを開ける",
    category: "crossword",
  },
  {
    id: "grossword-wins-1",
