...
exports.getBoard = exports.logstringfy = exports.Board = exports.str2command = exports.iscommand = void 0;
const deepcopy_1 = __importDefault(require("deepcopy"));
const rust_proxy = __importStar(require("./rust-proxy"));
function rep(n, f) { for (let i = 0; i < n; i++)
    f(i); }
const colournames = [
    '赤', '緑', '青', '黄', '黒'
];
...
exports.str2command = str2command;
function samep(p, q) {
...
class Board {
    ...
    clone() {
        const res = new Board();
        res.size = (0, deepcopy_1.default)(this.size);
        res.walls = (0, deepcopy_1.default)(this.walls);
        res.robots = (0, deepcopy_1.default)(this.robots);
        res.goal = (0, deepcopy_1.default)(this.goal);
        res.logs = [];
        res.board = (0, deepcopy_1.default)(this.board);
        res.directions = (0, deepcopy_1.default)(this.directions);
        return res;
    }
    iscleared() {
...
exports.Board = Board;
const logstringfy = (log) => {
    return log.map(v => colournames[v.c] + directionnames[v.d]).join();
};
exports.logstringfy = logstringfy;
const getBoard = async (boardspec) => {
